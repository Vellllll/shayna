<template>
                                        ...
                                        <div class="product-thumbs-track ps-slider">
                                            <Carousel :items-to-show="3" :wrap-around="true">
                                                <Slide v-for="product in products" :key="product.id">
                                                    <div class="pt" @click=changeImage(thumbs[product.id-1]) :class="thumbs[product.id-1] == default_image ? 'active' : '' ">
  ...
  export default {
    ...
    data() {
        const products = [
            {
                id: '1', img: 'img/mickey1.jpg'
            },
            {
                id: '2', img: 'img/mickey2.jpg'
            },
            {
                id: '3', img: 'img/mickey3.jpg'
            },
            {
                id: '4', img: 'img/mickey4.jpg'
            }
        ];
        return {
